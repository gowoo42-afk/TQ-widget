...
# 1. 우분투 환경 나눔고딕 폰트 직접 등록 (글자 깨짐 및 에러 방지)
...
def create_widget():
    ...
    ax.spines['bottom'].set_color((1.0, 1.0, 1.0, 0.2)) # rgba 수정
